@php($page = array("5"=>true,"502"=>true,"5021"=>true))
...
<div class="row mt">
  <div class="col-lg-12">
    <div class="form-panel">
      <h4><i class="fa fa-angle-right"></i> Nova Federação</h4>
      <form class="form-horizontal style-form" method="post">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        @php(
          $fields=array(
            array("Nome","name","Nome da Federação. Exemplo: Brasil.","text","",true),
            array("Abreviação","abbr","Abreviação da Federação. Exemplo: BRA.","text","",true)
          )
        )
