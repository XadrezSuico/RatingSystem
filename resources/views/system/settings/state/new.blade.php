@php($page = array("5"=>true,"503"=>true,"5033"=>true))
...
<div class="row mt">
  <div class="col-lg-12">
    <div class="form-panel">
      <h4><i class="fa fa-angle-right"></i> Novo Estado</h4>
      <form class="form-horizontal style-form" method="post">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        @php(
          $fields=array(
            array("Nome","name","Nome do Estado. Exemplo: Paraná.","text","",true),
            array("Abreviação/UF","abbr","Abreviação do Estado ou UF. Exemplo: PR.","text","",true)
          )
        )
